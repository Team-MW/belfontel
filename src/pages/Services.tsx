...
const Services = () => {
    ...
    return (
        <div className="min-h-screen pt-24">
            <SEO
                title="Nos Services"
                description="Découvrez nos prestations de réparation de smartphones à Toulouse. Écran, batterie, micro-soudure. Des tarifs transparents et une intervention rapide."
            />
