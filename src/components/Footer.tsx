...
const Footer = () => {
    ...
    return (
        <footer className="bg-metallic-900 border-t border-metallic-700 mt-20">
            <div className="container-custom py-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    >
                        <h3 className="text-2xl font-bold neon-text mb-4">BELFONTEL</h3>
                        ...
                        <div className="text-gray-400 text-sm space-y-2">
                            <p className="flex items-center gap-2"><span className="text-primary">📍</span> 14 rue de la République, 31000 Toulouse</p>
                            <p className="flex items-center gap-2"><span className="text-primary">📞</span> 05 61 00 00 00</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <form className="flex gap-2">
                            <input
                                ...
                                className="flex-1 bg-metallic-800 border border-metallic-600 rounded-lg px-4 py-2 text-sm text-gray-300 focus:outline-none focus:border-primary transition-colors"
                            />
                            <button
                                type="submit"
                        ...
                        <div className="flex gap-4 mt-6">
                            {footerLinks.social.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 bg-metallic-800 rounded-lg flex items-center justify-center hover:bg-primary transition-all duration-300 hover:scale-110 group"
